...
function Chooseus() {
  const features = [
    ...
    { id: "03", title: "Data-Driven Approach", desc: "We rely on analytics and data insights to optimize campaigns for maximum impact." , img: cartpic},
    { id: "04", title: "Comprehensive Services", desc: "From SEO to paid advertising, we offer full-suite marketing solutions under one roof.",  img: cartpic },
    { id: "05", title: "Transparent Communication", desc: "We keep you informed with clear reporting and open communication at every step.",  img: cartpic },
    { id: "06", title: "Continuous Optimization", desc: "We analyze and refine strategies to ensure long-term success in your digital marketing efforts.",  img: cartpic },
  ];
