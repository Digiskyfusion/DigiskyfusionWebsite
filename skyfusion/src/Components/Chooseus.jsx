...
function Chooseus() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-medium mt-3 Roboto-thin">Why Choose Us</h1>
      <p className="text-2xl font-normal md:w-80 mt-3 poppins-thin">
      ...
      <div className="mt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((item, index) => (
            ...
            >
              {/* Faster Hover Background Image Transition */}
              {item.img && (
                <div
