...
>
  <div className='container flex flex-col md:flex-row justify-between items-center'>
    ...
    <div className='relative text-center md:text-start md:w-[60%] space-y-5 md:px-10 flex flex-col items-center md:items-start pt-6'>
      ...
      <h1 className='text-3xl md:text-6xl font-bold font-poppins leading-tight'>
      ...
      <div className="hidden md:block cursor-pointer">
        <button className="py-2 px-5 bg-gradient-to-r from-[#0E546A] to-[#F16D3C] rounded-full text-white cursor-pointer">
          Get Started
        </button>
      </div>
    </div>
